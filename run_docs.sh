...
echo "   ➡️  Documentation will open at: http://<available_ip>:8008/new-python-repo/"
echo "   ➡️  Use Ctrl+C to stop the server"
echo "   ➡️  Changes to .md files and docstrings will auto-reload"
echo
